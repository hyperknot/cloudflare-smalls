// one random color string, copied 1 million times to check isolate memory persistance
const globalColor = '#' + Math.floor(Math.random()*16777215).toString(16).padStart(6, '0');
